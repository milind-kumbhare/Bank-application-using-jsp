...
<table>
<tr>
<th colspan="2"><fieldset><h3 style="color:red"><font size=5>TRANSFER FORM</font></th></fieldset></tr>
<tr>
...
<input type="password" name="psw"></td></tr>
<tr>
<td><label> Target Account No:</label></td>
<td>
